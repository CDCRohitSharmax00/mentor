	...
	return (
		<div className="sm:container px-3 mx-auto">
			<div className="flex  flex-col mt-[40px] md:mt-[64px] md:flex-row  no-scrollbar justify-center md:justify-start">
				<a className="md:p-[32px] flex flex-col justify-between gap-4 p-5 w-full border-[#C6C6C8] border-[1px] rounded-[18px] md:mr-4 mb-4 md:mb-0">
					<div className="space-y-4">
						<p className="w-fit text-[14px] border-[1px] border-[#fc690c52] rounded-[48px] px-4 py-1 text-[#F25022] font-medium bg-gradient-to-r from-[#FC690C52]/10   to-white to-[90%]">
							STEP 1
						</p>
					...
					<div className="flex items-center justify-end border-b h-fit border-white group-hover:border-black duration-200">
						<p className="text-base font-medium underline">Shortlist Mentor</p>
						<svg
							width="32"
							height="32"
							fill="none"
				...
				<a className="md:p-[32px] flex flex-col justify-between gap-4 p-5 w-full border-[#C6C6C8] border-[1px] rounded-[18px] md:mr-4 mb-4 md:mb-0 relative">
					<svg
						width="100"
						height="100"
						fill="none"
					...
					<div className="flex items-center justify-end border-b h-fit border-white group-hover:border-black duration-200">
						<p className="text-base font-medium underline">Book Free Trial</p>
						<svg
							width="32"
							height="32"
							fill="none"
				...
				<a className="md:p-[32px] flex flex-col justify-between gap-4 p-5 w-full border-[#C6C6C8] border-[1px] rounded-[18px] md:mr-4 mb-4 md:mb-0 relative">
					...
					<div className="flex items-center justify-end border-b h-fit border-white group-hover:border-black duration-200">
						<p className="text-base font-medium underline">Start Preparing</p>
						<svg
							width="32"
							height="32"
							fill="none"
